...
wget https://raw.githubusercontent.com/OfficialBoomi/azure-atom-quickstart/main/scripts/requirements.txt
wget https://raw.githubusercontent.com/OfficialBoomi/azure-atom-quickstart/main/scripts/license_validation.py
